...
from app.api.dependencies.items import check_item_modification_permissions, get_item_by_id_from_path
...
def update_item_by_id(
    ...
    return ItemPublic.from_orm(item_repo.update_item(item=item, item_update=item_update))
...
def delete_item_by_id(
    ...
    deleted_id = item_repo.delete_item_by_id(item=item)
    return deleted_id
